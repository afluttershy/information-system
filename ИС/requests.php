...
<body class="body">
    <div class="list-orders">
        ...
        <div class="list-group">
			...
			<a href="new-request.php"><button type="button" class="addnewbtn btn btn-outline-success">Добавить новую заявку</button></a>
			<?php
				$host = 'std-mysql'; 
				$database = 'std_234'; 
				$user = 'std_234'; 
				...
				if ($result = $link->query($query)) {
					while ($row = $result->fetch_assoc()) {
						 echo '<a <a href="one-request.php?F='. $row['id'].'"><button type="button" class="list-group-item list-group-item-action">';
